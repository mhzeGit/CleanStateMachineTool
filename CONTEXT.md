...
- **Helper Modules** (stateless service objects): `GraphOperations`, `GraphInputHandler`, `ExpandedViewManager`, `GraphSerializer`, `PlayModeTracker`, `GraphViewAnimator`, `GraphValidation`
